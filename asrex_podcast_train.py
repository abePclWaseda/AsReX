...
# -------------------- パス設定 --------------------
IN_ROOT = Path("/mnt/work-qnap/llmc/J-CHAT/audio/podcast_train")
SEP_DIR = Path("/mnt/kiso-qnap3/yuabe/m1/AsReX/data/J-CHAT/audio/podcast_train")
TXT_DIR = Path("/mnt/kiso-qnap3/yuabe/m1/AsReX/data/J-CHAT/transcripts/podcast_train")
ALN_DIR = Path("/mnt/kiso-qnap3/yuabe/m1/AsReX/data/J-CHAT/text/podcast_train")
...
LOG_FILE = open("align_errors_podcast_train.log", "a")
